...
if __name__ == "__main__":
    ...
    strategy        = policy+str(config['MAIN']['Strategy'])+str(config['MAIN']['BotNumber']) # trading strategy name for orders
    securities      = str(config['MAIN']['Securities']).split(",") # List of securities to listen and trade on
